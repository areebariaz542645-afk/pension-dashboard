...
# Strict page configurations to force light background natively
st.set_page_config(page_title="Welfare Pension Portal", page_icon="🩺", layout="centered")

# --- CLEAN & SAFE NATIVE THEME INJECTION ---
# Is CSS se ab koi element ya chart blank ya gayab nahi hoga
st.markdown("""
<style>
    /* Force complete app workspace to clean light grey */
    .stApp {
        background-color: #f8fafc !important;
    }
    
    /* Ensure all structural texts stay perfectly readable */
    h1, h2, h3, h4, h5, h6, p, label {
        color: #0f172a !important;
        font-family: 'Segoe UI', system-ui, sans-serif !important;
    }
    
    /* Clean custom white panel card style */
    .clean-card {
    ...
    /* Locked Easypaisa Green Style Banner */
    .easypaisa-wallet {
    ...
    /* Remove default dark line adjustments */
...
if not st.session_state['unlocked']:
    ...
    st.markdown("<p style='text-align: center; font-size: 13px; margin-bottom: 20px;'>Securely access active welfare asset telemetry parameters.</p>", unsafe_allow_html=True)
...
# --- SCREEN 2: ACTIVE PENSION DASHBOARD ---
    ...
    <div style='background-color: #f1f5f9; padding: 12px 16px; border-radius: 12px; border-left: 5px solid #006643; margin-bottom: 20px;'>
        <p style='margin:0; font-size:11px; font-weight:700; color:#006643 !important;'>🛡️ VERIFIED GOVERNMENT RETIREMENT CREDENTIALS</p>
    ...
    # THE REAL EASYPAISA FINANCIAL WALLET CARD
    st.markdown(f"""
    <div class='easypaisa-wallet'>
        <p style='margin:0; font-size:11px; font-weight: 500; opacity:0.9;'>🟢 AVAILABLE MONTHLY WELFARE BALANCE</p>
    ...
    # Real-time native data visualization engine (NATIVE & RE-ENABLED)
    ...
    # Forecast Data Grid Matrix Dataframe (NATIVE & RE-ENABLED)
